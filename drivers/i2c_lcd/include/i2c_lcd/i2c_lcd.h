...
#if PICO_ON_DEVICE
extern I2C_LCD *i2c_lcd_new (int width, int height, 
               int addr, i2c_inst_t *i2c, int sda, int scl, int i2c_baud, 
...
extern int      i2c_lcd_write (I2C_LCD *self, const char *buffer, int c);
